...
public class ModifiableInt 
{
    ...
    public int ModifiedValue { get { return modifiedValue; } private set { modifiedValue = value; /*UpdateModiedValue();*/ } }
    ...
    public void AddModifier(IModifiers p_modifier)
    {
        modifiers.Add(p_modifier);
        UpdateModifiedValue();
    }
    public void RemoveModifier(IModifiers p_modifier)
    {
